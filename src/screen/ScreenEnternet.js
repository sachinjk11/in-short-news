...
import searchEnternet from '../api/useSearchEnternet';
import { Loading } from '../Components/LoadingComponent';
import BannerAd from '../Components/bannerAd';

const EnternetScreen = ({ navigation }) => {

const [business, results, errorMessage, isLoading] = searchEnternet();
const listHeader =[];
var unqList = [];
